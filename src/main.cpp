...
uint256 hashGenesisBlock("0x15b59c6e94494e4aa37b9a7e2b31b45e74cdee2764d2393928d613718eeb2ae7");
...
const string strMessageMagic = "JimCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // JimCoin: 1 days
static const int64 nTargetSpacing = 120; // JimCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal jimcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "JimCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe0f91ee296b35c939fc7d6442652185454d74f2391d09e16d064d3219f0e82ec");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1388654064; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2220223;

        if (fTestNet)
        {
            block.nTime    = 1388558989;
            block.nNonce   = 872269;
        }
